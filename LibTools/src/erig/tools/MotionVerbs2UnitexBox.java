 ...
 */
public class MotionVerbs2UnitexBox  {
	...
	public static void main(String[] args) throws Exception
	{
		...
		String file = "/Users/lmoncla/YACCA/test/motionVerbs/motion.txt";
			String output = "/Users/lmoncla/YACCA/test/motionVerbs/motion_unitex_"+tense+".txt";
			...
			try {
					...
					content = content.replaceAll(" ", ".V+"+tense+">+<");
					content = "<"+content+".V+"+tense+">";
